...
app.get('/api/districts/:election_id', (req, res) => {
  return queries.districts({
    electionId: req.params.election_id
  }).then(result => res.send(result));
});
...
app.get('/api/locations/:municipality_id', (req, res) => {
  ...
  return queries.locations({
    municipalityId: req.params.municipality_id
  }).then(result => res.send(result));
});
...
app.get('/api/mayor_municipality_section_result', (req, res) => {
  console.log('mayor_municipality_section_result', req.params)
  return queries
    .mayor_municipality_section_result({
      election_id: req.query.electionId,
      municipality_id: req.query.municipalityId,
      round: req.query.round,
      lat: req.query.lat,
      lng: req.query.lng
    })
