...
export default function MayorMunicipalityElections() {
  ...
  const setDistrict = (districtId: number) => history.push(`/elections/mm/${electionId}/${districtId}`)
  const setMunicipality = (municipalityId: number) => history.push(`/elections/mm/${electionId}/${districtId}/${municipalityId}`)
  ...
  return (
    <>
      ...
      <Dropdown
        ...
        onChange={(newRound: number) => history.push(`/elections/mm/${electionId}/${districtId}/${municipalityId}/${newRound}`)}
        title="Тур"
      />
