...
insert or ignore into sections (election_period_id, location_id, section_code, mobile_section) select 1, (select id from locations where locations.ekatte=_2019_mayor_1_sections.ekatte), section_id, mobile_section from _2019_mayor_1_sections;
drop table _2019_mayor_1_sections;
insert or ignore into sections (election_period_id, location_id, section_code, mobile_section) select 1, (select id from locations where locations.ekatte=_2019_mayor_region_1_sections.ekatte), section_id, mobile_section from _2019_mayor_region_1_sections;
...
insert or ignore into sections (election_period_id, location_id, section_code, mobile_section) select 1, (select id from locations where locations.ekatte=_2019_mayor_2_sections.ekatte), section_id, mobile_section from _2019_mayor_2_sections;
